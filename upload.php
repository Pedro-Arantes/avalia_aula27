...
$nome=$_POST["nome"];
$valor=$_POST["valor"];
$estoquemx=$_POST["estoquemax"];
$estoquemn=$_POST["estoquemin"];
...
if ($uploadOk == 0) {
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        ...
        $sql = "insert into tblprodutos (nome,imagem,valor,estoquemax,estoquemin,estoque) values ('$nome','$target_file','$valor','$estoquemx','$estoquemn','$estoque')";
